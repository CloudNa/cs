...
//		$basics_config = $basics_config[ 'data' ][ 'value' ];
        ...
        $field = 'fgs.goods_sku_id,fgs.goods_id,fgs.sku_id,fgs.level_id,fgs.one_rate,fgs.one_money,fgs.two_rate,fgs.two_money,fgs.three_rate,fgs.three_money,gs.sku_name,gs.discount_price,gs.price,gs.stock,gs.sale_num,gs.sku_image,gs.site_id,gs.recommend_way,g.goods_image,g.goods_name,gs.fenxiao_price';
