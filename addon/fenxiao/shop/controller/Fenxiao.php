                    ...
                    foreach ($fenxiao_skus as $level_id => $level_data) {
                        foreach ($level_data[ 'sku_id' ] as $key => $sku_id) {
                            ...
                            foreach ($fenxiao_level as $level) {
                                if (isset($level_data[ $level . '_rate' ])){
                            ...
                            $fenxiao_sku = [
                                ...
                                'two_rate' => isset($level_data[ 'two_rate' ]) ? $level_data[ 'two_rate' ][ $key ] : "",
                                'two_money' => isset($level_data[ 'two_money' ]) ? $level_data[ 'two_money' ][ $key ] : "",
                                'three_rate' => isset($level_data[ 'three_rate' ]) ? $level_data[ 'three_rate' ][ $key ] : "",
                                'three_money' => isset($level_data[ 'three_money' ]) ? $level_data[ 'three_money' ][ $key ] : "",
                            ];
