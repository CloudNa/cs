    ...
    public function add()
    {
        if (request()->isAjax()) {
            ...
            $data = [
                ...
                'feeds_img' => input("feedsImg", ""),
                'closeReplay' => input('closeReplay', 1),
                'closeShare' => input('closeShare', 1),
...
//                'live_status' => '102',
                ...
                'site_name' => $this->shop_info[ 'site_name' ],
                'feeds_img' => input("feedsImg", ""),
                'close_replay' => input('closeReplay', 1),
                'close_share' => input('closeShare', 1),
                'close_kf' => input('closeKf', 1)
            );
    ...
    public function addImageMedia()
    {
        if (request()->isAjax()) {
            ...
            $result = $upload_model->setCloud(false)->setWater(false)->setPath($path)->image($param);
            return $result;
        }
    }
