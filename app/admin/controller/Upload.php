...
//		$thumb_type = input("thumb", "");
        ...
        $result = $upload_model->setPath("common/images/" . date("Ymd") . '/')->setWater(true)->imageToAlbum($param);
        return $result;
    }
    ...
    /**
     * 水印图专用
     * @return \app\model\upload\Ambigous|array|mixed|\multitype|string
     */
    public function water(){
        ...
        $result = $upload_model->setCloud(false)->setWater(false)->setPath("common/water/" . date("Ymd") . '/')->image($param);
        return $result;
    }
}