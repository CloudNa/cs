...
class DiyView extends BaseModel
{
    ...
    public function qrcode($condition, $type = "create")
    {
        ...
        }elseif($diy_view_info[ 'name' ] == $page[ 'city' ][ 'index' ][ 'name' ]){
            $data[ 'page' ] = '/otherpages/diy/diy/diy';
            $data[ 'data' ] = [
                'name' => $diy_view_info[ 'name' ],
                'site_id' => $site_id
            ];
    ...
    public function getMemberIndexDiyConfig($site_id)
    {
        ...
        if (empty($res[ 'data' ][ 'value' ])) {
            ...
            $presale_key = array_search('presale', array_column($menuList, 'tag'));
