...
--
--
DROP TABLE IF EXISTS shopcomponent_account;
--
--
...
--
--
DROP TABLE IF EXISTS site_member_message;
--
--
DROP TABLE IF EXISTS site_member_sub_message;
--
--
DROP TABLE IF EXISTS site_message_records;
--
--
...
CREATE TABLE order_export (
  ...
  app_module varchar(255) NOT NULL DEFAULT 'shop' COMMENT '应用模块',
...
CREATE TABLE weapp_live_room (
  ...
  feeds_img varchar(1000) NOT NULL DEFAULT '' COMMENT '购物直播频道封面图',
  close_replay int(11) NOT NULL DEFAULT 0 COMMENT '是否开启回放',
  close_share int(11) NOT NULL DEFAULT 0 COMMENT '是否开启分享',
  close_kf int(11) NOT NULL DEFAULT 0 COMMENT '是否开启客服',
  PRIMARY KEY (id)
)
ENGINE = INNODB,
CHARACTER SET utf8,
...
CREATE TABLE promotion_platformcoupon (
  ...
  get_type int(11) NOT NULL DEFAULT 0 COMMENT '获取方式1订单2.直接领取3.活动领取4.系统发放5.用户操作奖励6.会员级别升级送优惠券',
...
CREATE TABLE promotion_coupon_type (
  ...
  is_limitcount tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否限制领取数量,0限制，1无限制',
...
CREATE TABLE order_refund_log (
  ...
  refund_status_name varchar(255) NOT NULL DEFAULT '' COMMENT '退款状态名称',
  `action` varchar(255) NOT NULL DEFAULT '' COMMENT '操作内容',
  action_way varchar(255) NOT NULL DEFAULT '0',
  action_userid int(11) NOT NULL DEFAULT 0 COMMENT '操作人id',
  username varchar(255) NOT NULL DEFAULT '' COMMENT '操作人名称',
  action_time int(11) NOT NULL DEFAULT 0 COMMENT '操作时间',
  PRIMARY KEY (id)
...
CREATE TABLE message (
  ...
  sitemessage_is_open int(11) NOT NULL DEFAULT 0 COMMENT '站内信是否启动',
...
CREATE TABLE member_recharge_order (
  ...
  price decimal(11, 2) NOT NULL COMMENT '实付金额',
...
CREATE TABLE member (
  ...
  is_edit_username int(1) NOT NULL DEFAULT 1 COMMENT '是否能修改username   0-不可修改  1-可以修改',
...
CREATE TABLE config (
  ...
  `value` varchar(20000) NOT NULL DEFAULT '' COMMENT '配置值json',
...
(28, 0, 'FENXIAO_WITHDRAWAL_ERROR', 2, '分销提现失败结果通知', '尊敬的{fenxiaoname}，您申请的{money}余额，提现审核失败。', '{"fenxiaoname":"others","money":"amount"}', 0, 0, 0, 1608274672),
(29, 0, 'RECHARGE_SUCCESS', 2, '余额充值', '尊敬的{username}，您好！您成功充值余额{money}元。', '{"username":"others","money":"amount"}', 0, 0, 0, 1620814518);
...
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (1, '', 'ORDER_CREATE', '订单创建通知', 1, '{\"orderno\":\"订单号\"}', 0, '', '', 1, '', '{\"alisms\":{\"template_id\":\"\",\"content\":\"尊敬的会员，您的订单已创建，订单号${orderno}。\",\"smssign\":\"\"}}', '【{sitename}】,您的验证码{code},请不要泄露得1其他人', 1, '{\"template_id_short\":\"OPENTM401874876\",\"template_id\":\"\",\"headtext\":\"\",\"bottomtext\":\"\",\"headtextcolor\":\"#e73030\",\"bottomtextcolor\":\"\",\"content\":\"订单号：{{keyword1.DATA}}\\n下单时间：{{keyword2.DATA}}\\n产品详情：{{keyword3.DATA}}\\n需支付金额：{{keyword4.DATA}}\\n收货详情：{{keyword5.DATA}}\"}', 0, '', 0, '', 'sms,email,wechat,sitemessage,sitemessage', 0, '{\"content\":\"尊敬的{username}，您的订单已创建，订单号{orderno}。\"}');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (2, '', 'ORDER_CLOSE', '订单关闭通知', 1, '{\"orderno\":\"订单号\"}', 1, '订单关闭', '<p>尊敬的会员，您的订单{订单号}，已关闭</p>', 1, '', '{\"alisms\":{\"template_id\":\"\",\"content\":\"尊敬的会员，您的订单${orderno}，已关闭。\",\"smssign\":\"\"}}', '', 1, '{\"template_id_short\":\"OPENTM205543831\",\"template_id\":\"\",\"headtext\":\"\",\"bottomtext\":\"\",\"headtextcolor\":\"\",\"bottomtextcolor\":\"\",\"content\":\"订单商品：{{keyword1.DATA}}\\n订单编号：{{keyword2.DATA}}\\n下单时间：{{keyword3.DATA}}\\n订单金额：{{keyword4.DATA}}\\n关闭时间：{{keyword5.DATA}}\"}', 0, '', 0, '', 'sms,email,wechat,sitemessage,sitemessage', 0, '{\"content\":\"尊敬的{username}，您的订单已创建，订单号{orderno}。\"}');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (3, '', 'ORDER_COMPLETE', '订单完成通知', 1, '{\"orderno\":\"订单号\"}', 0, '订单完成', '<p>尊敬的会员，您的订单{订单号}，交易成功</p>', 1, '', '{\"alisms\":{\"template_id\":\"\",\"content\":\"尊敬的会员，您的订单${orderno}，交易成功。\",\"smssign\":\"\"}}', '', 1, '{\"template_id_short\":\"OPENTM412034601\",\"template_id\":\"\",\"headtext\":\"您的订单已完成。\",\"bottomtext\":\"详情请登录公众号查看。\",\"headtextcolor\":\"#fe0000\",\"bottomtextcolor\":\"#1f7af2\",\"content\":\"订单单号：{{keyword1.DATA}}\\n订单商品：{{keyword2.DATA}}\\n下单时间：{{keyword3.DATA}}\"}', 0, '', 0, '', 'sms,email,wechat,sitemessage,sitemessage', 0, '{\"content\":\"尊敬的{username}，您的订单已创建，订单号{orderno}。\"}');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (4, '', 'ORDER_PAY', '订单支付通知', 1, '{\"orderno\":\"订单号\",\"username\":\"会员名称\",\"ordermoney\":\"订单金额\"}', 0, '订单支付', '<p>亲爱的{会员名称},你的订单号为{订单号}的订单已成功支付,支付金额{订单金额}</p>', 1, '', '{\"alisms\":{\"template_id\":\"\",\"content\":\"亲爱的${username},你的订单号为${orderno}的订单已成功支付,支付金额${ordermoney}\",\"smssign\":\"\"}}', '', 1, '{\"template_id_short\":\"OPENTM402074360\",\"template_id\":\"CDdclx9Oz93xQrB1bmxe3P1PvPld9VoumWNH5PTAeTU\",\"headtext\":\"\",\"bottomtext\":\"\",\"headtextcolor\":\"\",\"bottomtextcolor\":\"\",\"content\":\"下单时间：{{keyword1.DATA}}\\n订单编号：{{keyword2.DATA}}\\n商品信息：{{keyword3.DATA}}\\n订单金额：{{keyword4.DATA}}\"}', 0, '{\"tid\":\"6271\",\"kidList\":[7,1,4,3],\"content\":\"下单时间{{time7.DATA}}\n订单编号{{character_string1.DATA}}\n商品名称{{thing4.DATA}}\n订单金额{{amount3.DATA}}\",\"sceneDesc\":\"订单完成通知\",\"weapp_template_id\":\"\"}', 0, '', 'sms,email,wechat,weapp,sitemessage,weapp,sitemessage', 0, '{\"content\":\"尊敬的{username}，你的订单号为{orderno}的订单已成功支付,支付金额{ordermoney}\"}');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (5, '', 'ORDER_DELIVERY', '订单发货通知', 1, '{\"orderno\":\"订单号\"}', 0, '', '', 1, '', '{\"alisms\":{\"template_id\":\"\",\"content\":\"尊敬的会员，您的订单已发货，订单号${orderno}。\",\"smssign\":\"\"}}', '', 1, '{\"template_id_short\":\"OPENTM406700005\",\"template_id\":\"\",\"headtext\":\"\",\"bottomtext\":\"\",\"headtextcolor\":\"\",\"bottomtextcolor\":\"\",\"content\":\"订单编号：{{keyword1.DATA}}\\n商品名称：{{keyword2.DATA}}\\n商品件数：{{keyword3.DATA}}\\n支付金额：{{keyword4.DATA}}\\n发货时间：{{keyword5.DATA}}\"}', 0, '{\"tid\":\"3637\",\"kidList\":[2,1,7,3],\"content\":\"订单号{{character_string2.DATA}}\n商品名称{{thing1.DATA}}\n订单金额{{amount7.DATA}}\n发货时间{{date3.DATA}}\",\"sceneDesc\":\"订单发货通知\",\"weapp_template_id\":\"\"}', 0, '', 'sms,email,wechat,weapp,sitemessage,weapp,sitemessage', 0, '{\"content\":\"尊敬的{username}，您的订单已发货，订单号{orderno}。\"}');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (6, '', 'ORDER_TAKE_DELIVERY', '订单收货通知', 1, '{\"orderno\":\"订单号\"}', 0, '订单收货成功', '<p>尊敬的会员，您的订单{订单号}，收货成功</p>', 1, '', '{\"alisms\":{\"template_id\":\"\",\"content\":\"尊敬的会员，您的订单${orderno}，收货成功。\",\"smssign\":\"\"}}', '', 1, '{\"template_id_short\":\"OPENTM418052192\",\"template_id\":\"\",\"headtext\":\"\",\"bottomtext\":\"\",\"headtextcolor\":\"\",\"bottomtextcolor\":\"\",\"content\":\"收货地址：{{keyword1.DATA}}\\n联系人：{{keyword2.DATA}}\\n订单号：{{keyword3.DATA}}\\n订单详情：{{keyword4.DATA}}\\n操作时间：{{keyword5.DATA}}\"}', 0, '{\"tid\":\"12340\",\"kidList\":[9,1,2,7],\"content\":\"确认收货人{{thing9.DATA}}\n订单号{{character_string1.DATA}}\n商品名称{{thing2.DATA}}\n收货时间{{time7.DATA}}\",\"sceneDesc\":\"订单收货通知\",\"weapp_template_id\":\"\"}', 0, '', 'sms,email,wechat,weapp,sitemessage,weapp,sitemessage', 0, '{\"content\":\"尊敬的{username}，您的订单{orderno}，收货成功。\"}');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (7, '', 'ORDER_REFUND_AGREE', '商家同意退款', 1, '{\"orderno\":\"订单号\"}', 0, '商家同意退款', '<p>尊敬的会员，您的订单{订单号}，商家同意退款</p>', 1, '', '{\"alisms\":{\"template_id\":\"\",\"content\":\"尊敬的会员，您的订单${orderno}，商家同意退款。\",\"smssign\":\"\"}}', '', 0, '{\"template_id_short\":\"OPENTM412135258\",\"template_id\":\"\",\"headtext\":\"\",\"bottomtext\":\"\",\"headtextcolor\":\"\",\"bottomtextcolor\":\"\",\"content\":\"订单号：{{keyword1.DATA}}\\n退款金额：{{keyword2.DATA}}\\n时间：{{keyword3.DATA}}\"}', 0, '{\"tid\":\"6964\",\"kidList\":[3,1,7],\"content\":\"订单编号{{character_string3.DATA}}\n退款金额{{amount1.DATA}}\n申请结果{{phrase7.DATA}}\",\"sceneDesc\":\"商家同意退款\",\"weapp_template_id\":\"\"}', 0, '', 'sms,email,wechat,weapp,sitemessage,weapp,sitemessage', 0, '{\"content\":\"尊敬的{username}，您的订单{orderno}，商家同意退款。\"}');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (8, '', 'ORDER_REFUND_REFUSE', '商家拒绝退款', 1, '{\"orderno\":\"订单号\"}', 0, '商家拒绝退款', '<p>尊敬的会员，您的订单{订单号}，商家拒绝退款</p>', 1, '', '{\"alisms\":{\"template_id\":\"\",\"content\":\"尊敬的会员，您的订单${orderno}，商家拒绝退款。\",\"smssign\":\"\"}}', '', 1, '{\"template_id_short\":\"OPENTM417819857\",\"template_id\":\"\",\"headtext\":\"\",\"bottomtext\":\"\",\"headtextcolor\":\"\",\"bottomtextcolor\":\"\",\"content\":\"单号：{{keyword1.DATA}}\\n金额：{{keyword2.DATA}}\\n时间：{{keyword3.DATA}}\"}', 0, '{\"tid\":\"6952\",\"kidList\":[4,3],\"content\":\"订单号{{character_string4.DATA}}\n退款金额{{amount3.DATA}}\",\"sceneDesc\":\"商家同意退款\",\"weapp_template_id\":\"\"}', 0, '', 'sms,email,wechat,weapp,sitemessage,weapp,sitemessage', 0, '{\"content\":\"尊敬的{username}，您的订单{orderno}，商家拒绝退款。\"}');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (9, '', 'VERIFY', '核销取货', 1, '{\"orderno\":\"订单号\"}', 0, '核销成功', '<p>尊敬的会员，您的订单{订单号}，商家核销成功</p>', 1, '', '{\"alisms\":{\"template_id\":\"\",\"content\":\"尊敬的会员，您的订单${orderno}，商家核销成功。\",\"smssign\":\"\"}}', '', 1, '{\"template_id_short\":\"OPENTM416687547\",\"template_id\":\"\", \"headtext\": \"\", \"bottomtext\": \"\", \"headtextcolor\": \"\", \"bottomtextcolor\": \"\", \"content\": \"商品名称：{{keyword1.DATA}}\\n商品数量：{{keyword2.DATA}}\\n核销时间：{{keyword3.DATA}}\"}', 0, '', 0, '', 'sms,email', 0, '');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (10, '', 'BUYER_REFUND', '买家发起退款提醒', 2, '{\"username\":\"会员名称\",\"goodsname\":\"商品名称\",\"orderno\":\"订单号\",\"refundmoney\":\"退款金额\",\"refundreason\":\"退款原因\",\"refundno\":\"退款单号\"}', 1, '买家发起退款1', '<p>{会员名称}申请了退款，订单号为{订单号}的商品{商品名称}，退款单号为{退款单号}，退款金额{退款金额}，退款原因{退款原因}。</p>', 0, '', '{\"alisms\":{\"template_id\":\"\",\"content\":\"${username}申请了退款，订单号为${orderno}的商品${goodsname}，退款单号为${refundno}，退款金额${refundmoney}，退款原因${refundreason}。\",\"smssign\":\"\"}}', '', 1, '{\"template_id_short\":\"OPENTM412244458\",\"template_id\":\"\",\"headtext\":\"\",\"bottomtext\":\"\",\"headtextcolor\":\"\",\"bottomtextcolor\":\"\",\"content\":\"退款单号：{{keyword1.DATA}}\\n申请时间：{{keyword2.DATA}}\\n退款金额：{{keyword3.DATA}}\"}', 0, '', 0, '', 'sms,email,wechat', 0, '');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (11, '', 'BUYER_DELIVERY_REFUND', '买家已退货提醒', 2, '{\"orderno\":\"订单号\"}', 1, '买家退货通知', '<p>订单号为{订单号}，买家退货。</p>', 1, '', '{\"alisms\":{\"template_id\":\"\",\"content\":\"订单号为${orderno}，买家退货。\",\"smssign\":\"\"}}', '', 1, '{\"template_id_short\":\"OPENTM206905995\",\"template_id\":\"\",\"headtext\":\"\",\"bottomtext\":\"\",\"headtextcolor\":\"\",\"bottomtextcolor\":\"\",\"content\":\"退货订单号：{{keyword1.DATA}}\\n退货商品：{{keyword2.DATA}}\\n退货数量：{{keyword3.DATA}}\\n退货金额：{{keyword4.DATA}}\"}', 0, '', 0, '', 'sms,email,wechat', 0, '');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (12, '', 'REGISTER_CODE', '注册验证', 1, '{\"code\":\"验证码\",\"site_name\":\"站点名称\"}', 0, '发送邮箱注册验证码', '<p>{站点名称}发送邮箱注册验证码{验证码}</p>', 0, '', '{\"alisms\":{\"template_id\":\"\",\"content\":\"{code}您的验证码{site_name}为：${code}，该验证码 5 分钟内有效，请勿泄漏于他人。\",\"smssign\":\"\"}}', '', 0, '', 0, '', 0, '', 'sms,email', 0, '');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (13, '', 'REGISTER_SUCCESS', '注册成功', 1, '{\"shopname\":\"商城名称\",\"username\":\"会员名称\"}', 0, '会员注册成功通知', '<p>尊敬的{会员名称},您已成功注册为{商城名称}用户。</p>', 1, '', '{\"alisms\":{\"template_id\":\"\",\"content\":\"尊敬的${username},您以成功注册为${shopname}用户。\",\"smssign\":\"\"}}', '', 1, '{\"template_id_short\":\"OPENTM409413579\",\"template_id\":\"\",\"headtext\":\"\",\"bottomtext\":\"\",\"headtextcolor\":\"\",\"bottomtextcolor\":\"\",\"content\":\"注册账号：{{keyword1.DATA}}\\n注册时间：{{keyword2.DATA}}\"}', 0, '', 0, '', 'sms,email,wechat', 0, '');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (14, '', 'FIND_PASSWORD', '找回密码', 1, '{\"code\":\"验证码\",\"site_name\":\"站点名称\"}', 1, '发送邮箱找回密码验证码', '\r\n<p>{站点名称}发送邮箱找回密码验证码{验证码}</p>', 1, '', '{\"alisms\":{\"template_id\":\"\",\"content\":\"您的验证码为：${number}，该验证码 5 分钟内有效，请勿泄漏于他人。\",\"smssign\":\"\"}}', '', 0, '', 0, '', 0, '', 'sms,email', 0, '');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (15, '', 'LOGIN', '会员登录', 1, '{\"name\":\"会员名称\"}', 1, '会员登录', '<p>尊敬的{会员名称}，您的账号登陆成功。</p>', 1, '', '{\"alisms\":{\"template_id\":\"\",\"content\":\"尊敬的${name}，您的账号登陆成功。\",\"smssign\":\"\"}}', '', 1, '{\"template_id_short\":\"OPENTM412447375\",\"template_id\":\"\",\"headtext\":\"\",\"bottomtext\":\"\",\"headtextcolor\":\"\",\"bottomtextcolor\":\"\",\"content\":\"登录账号：{{keyword1.DATA}}\\n登录状态：{{keyword2.DATA}}\\n登录时间：{{keyword3.DATA}}\"}', 0, '', 0, '', 'sms,email,wechat', 0, '');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (16, '', 'MEMBER_BIND', '账户绑定', 1, '{\"code\":\"验证码\",\"site_name\":\"站点名称\"}', 1, '发送邮箱绑定验证码', '<p>{站点名称}发送邮箱绑定验证码{验证码}</p>', 1, '', '{\"alisms\":{\"template_id\":\"\",\"content\":\"\",\"smssign\":\"\"}}', '', 0, '', 0, '', 0, '', 'sms,email', 0, '');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (17, '', 'LOGIN_CODE', '动态码登录', 1, '{\"code\":\"验证码\"}', 0, '', '<p>您的验证码为：{验证码}，该验证码 5 分钟内有效，请勿泄漏于他人。</p>', 1, '', '{\"alisms\":{\"template_id\":\"\",\"content\":\"您的验证码为：${code}，该验证码 5 分钟内有效，请勿泄漏于他人。\",\"smssign\":\"\"}}', '', 0, '', 0, '', 0, '', 'sms,email', 0, '');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (18, '', 'SET_PASSWORD', '设置密码', 1, '{\"code\":\"验证码\"}', 0, '', '', 1, '', '{\"alisms\":{\"template_id\":\"\",\"content\":\"您的验证码为：${code}，该验证码 5 分钟内有效，请勿泄漏于他人。\",\"smssign\":\"\"}}', '', 0, '', 0, '', 0, '', 'sms', 0, '');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (19, '', 'BUYER_TAKE_DELIVERY', '买家收货通知', 2, '{\"orderno\":\"订单号\"}', 0, '', '', 0, '', '', '', 0, '{\"template_id_short\":\"OPENTM418052192\",\"template_id\":\"\",\"headtext\":\"\",\"bottomtext\":\"\",\"headtextcolor\":\"\",\"bottomtextcolor\":\"\",\"content\":\"收货地址：{{keyword1.DATA}}\\n联系人：{{keyword2.DATA}}\\n订单号：{{keyword3.DATA}}\\n订单详情：{{keyword4.DATA}}\\n操作时间：{{keyword5.DATA}}\"}', 0, '', 0, '', 'sms,email,wechat', 0, '');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (20, '', 'BUYER_PAY', '买家支付通知', 2, '{\"orderno\":\"订单号\",\"ordermoney\":\"订单金额\"}', 0, '', '', 0, '', '', '', 0, '{\"template_id_short\":\"OPENTM402074360\",\"template_id\":\"\",\"headtext\":\"\",\"bottomtext\":\"\",\"headtextcolor\":\"\",\"bottomtextcolor\":\"\",\"content\":\"下单时间：{{keyword1.DATA}}\\n订单编号：{{keyword2.DATA}}\\n商品信息：{{keyword3.DATA}}\\n订单金额：{{keyword4.DATA}}\"}', 0, '', 0, '', 'sms,email,wechat', 0, '');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (21, '', 'USER_WITHDRAWAL_APPLY', '会员申请提现通知', 2, '{\"username\":\"会员名称\",\"money\":\"提现金额\"}', 0, '', '', 0, '', '', '', 0, '{\"template_id_short\":\"OPENTM416719519\",\"template_id\":\"\",\"headtext\":\"\",\"bottomtext\":\"\",\"headtextcolor\":\"\",\"bottomtextcolor\":\"\",\"content\":\"申请人：{{keyword1.DATA}}\\n创建时间：{{keyword2.DATA}}\\n申请金额：{{keyword3.DATA}}\"}', 0, '', 0, '', 'sms,email,wechat', 0, '');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (22, '', 'FENXIAO_WITHDRAWAL_APPLY', '分销申请提现通知', 2, '{\"fenxiaoname\":\"分销商名称\",\"money\":\"提现金额\"}', 0, '', '', 0, '', '', '', 0, '{\"template_id_short\":\"OPENTM416719519\",\"template_id\":\"\",\"headtext\":\"\",\"bottomtext\":\"\",\"headtextcolor\":\"\",\"bottomtextcolor\":\"\",\"content\":\"申请人：{{keyword1.DATA}}\\n创建时间：{{keyword2.DATA}}\\n申请金额：{{keyword3.DATA}}\"}', 0, '', 0, '', 'sms,email,wechat', 0, '');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (23, '', 'USER_WITHDRAWAL_SUCCESS', '会员提现成功通知', 1, '{\"username\":\"会员名称\",\"money\":\"提现金额\"}', 0, '', '', 0, '', '{\"alisms\":{\"template_id\":\"\",\"content\":\"尊敬的{username}，您申请的{money}余额，已提现成功。\",\"smssign\":\"\"}}', '', 0, '', 0, '{\"tid\":\"5184\",\"kidList\":[6,3],\"content\":\"提现金额{{amount6.DATA}}\n提现时间{{date3.DATA}}\",\"sceneDesc\":\"会员提现成功通知\",\"weapp_template_id\":\"\"}', 0, '', 'sms,email,weapp,sitemessage,weapp,sitemessage', 0, '{\"content\":\"尊敬的{username}，您申请的{money}余额，已提现成功。\"}');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (24, '', 'FENXIAO_WITHDRAWAL_SUCCESS', '分销提现成功通知', 1, '{\"fenxiaoname\":\"分销商名称\",\"money\":\"提现金额\"}', 0, '', '', 0, '', '{\"alisms\":{\"template_id\":\"\",\"content\":\"尊敬的{fenxiaoname}，您申请的{money}佣金，已提现成功。\",\"smssign\":\"\"}}', '', 0, '', 0, '{\"tid\":\"6699\",\"kidList\":[1,2,3],\"content\":\"提现金额{{amount1.DATA}}\n提现时间{{time2.DATA}}\n备注{{thing3.DATA}}\",\"sceneDesc\":\"会员申请提现通知\",\"weapp_template_id\":\"\"}', 0, '', 'sms,email,weapp,weapp', 0, '');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (25, '', 'USER_CANCEL_SUCCESS', '会员注销成功', 1, '{\"username\":\"会员账号\"}', 0, '', '', 0, '', '', '', 0, '', 0, '', 0, '', 'sms,email', 0, '');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (26, '', 'USER_CANCEL_FAIL', '会员注销失败', 1, '{\"username\":\"会员账号\"}', 0, '', '', 0, '', '', '', 0, '', 0, '', 0, '', 'sms,email', 0, '');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (27, '', 'USER_CANCEL_APPLY', '会员注销申请', 2, '{\"username\":\"会员账号\"}', 0, '', '', 0, '', '', '', 0, '{\"template_id_short\":\"OPENTM413481457\",\"template_id\":\"\",\"headtext\":\"\",\"bottomtext\":\"\",\"headtextcolor\":\"\",\"bottomtextcolor\":\"\",\"content\":\"申请人：{{keyword1.DATA}}\\n手机号码：{{keyword2.DATA}}\"}', 0, '', 0, '', 'sms,email,wechat', 0, '');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (28, '', 'FENXIAO_WITHDRAWAL_ERROR', '分销提现失败通知', 1, '{\"fenxiaoname\":\"分销商名称\",\"money\":\"提现金额\"}', 0, '', '', 0, '', '{\"alisms\":{\"template_id\":\"\",\"content\":\"尊敬的{username}，您申请的{money}佣金，已提现成功。\",\"smssign\":\"\"}}', '', 0, '{\"template_id_short\":\"OPENTM417749055\",\"template_id\":\"\",\"headtext\":\"会员提现失败通知\",\"bottomtext\":\"进入商城查看详情\",\"headtextcolor\":\"\",\"bottomtextcolor\":\"\",\"content\":\"提现时间：{{keyword1.DATA}}\\n审核状态：{{keyword2.DATA}}\\n提现方式：{{keyword3.DATA}}\\n提现金额：{{keyword4.DATA}}\"}', 0, '{\"tid\":\"18547\",\"kidList\":[2,4],\"content\":\"提现金额{{amount2.DATA}}\n提现进度{{thing4.DATA}}\",\"sceneDesc\":\"分销提现失败通知\",\"weapp_template_id\":\"\"}', 0, '', 'sms,wechat,weapp,weapp', 0, '');
INSERT INTO `message`(`id`, `addon`, `keywords`, `title`, `message_type`, `message_json`, `email_is_open`, `email_title`, `email_content`, `sms_is_open`, `sms_addon`, `sms_json`, `sms_content`, `wechat_is_open`, `wechat_json`, `weapp_is_open`, `weapp_json`, `aliapp_is_open`, `aliapp_json`, `support_type`, `sitemessage_is_open`, `sitemessage_json`) VALUES (29, '', 'RECHARGE_SUCCESS', '会员充值成功通知', 1, '{\"username\":\"会员名称\",\"money\":\"提现金额\"}', 0, '充值成功提醒', '<p>尊敬的{会员名称}，您的账户充值{充值金额}。</p>', 0, '', '{\"alisms\":{\"template_id\":\"\",\"content\":\"尊敬的{username}，您好！您在{create_time}成功充值余额{money}元。\",\"smssign\":\"\"}}', '', 0, '', 0, '', 0, '', 'sms,email,sitemessage', 0, '{\"content\":\"尊敬的{username}，您好！您在{create_time}成功充值余额{money}元。\"}');


INSERT INTO member_level VALUES
(1, '普通会员', 0, 0.00, '普通会员', 1, 0, 100.00, 0.00, 0, 0.00, '', 0, '', 0, '#333', 1, 0);

INSERT INTO express_company VALUES
(1, '顺丰速运', 'upload/default/express/shunfeng.jpg', 'https://www.sf-express.com/cn/sc/', 1, 'SF', '100免费版编码', '100免费版编码', 'SF', '', '[{"item_name":"logistics_number","item_title":"货到付款物流编号","left":273.96875,"top":259.96875},{"item_name":"sender_address","item_title":"发件人地址","left":227.96875,"top":141.96875},{"item_name":"sender_name","item_title":"发件人姓名","left":44.953125,"top":162.984375},{"item_name":"collection_payment","item_title":"代收金额","left":252.96875,"top":45.96875}]', '', '14', '766', '510', 0, 0, 0.00, 0, ''),
(2, '韵达快递', 'upload/default/express/yunda.jpg', 'http://www.yundaex.com/cn/index.php', 2, 'YD', 'yunda', 'yunda', 'YUNDA', '', '[{"item_name":"order_no","item_title":"订单编号","left":61,"top":36},{"item_name":"receiver_post_code","item_title":"收件人邮编","left":136,"top":90},{"item_name":"logistics_number","item_title":"货到付款物流编号","left":227,"top":130},{"item_name":"collection_payment","item_title":"代收金额","left":181,"top":216}]', '', '14', '766', '510', 0, 0, 0.00, 0, '');
