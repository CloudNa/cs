...
class Category extends BaseModel
{
    ...
    public function uploadQualifications($param, $site_id)
    {
        ...
        if (isset($param['leimu_qualification'])) array_push($data['category_info']['certificate'], img($param['leimu_qualification']));
        if (isset($param['product_qualification'])) array_push($data['category_info']['certificate'], img($param['product_qualification']));
        ...
        $audit_data = [
            ...
            'audit_id' => $res['data'],
            'audit_time' => time(),
            'certificate' => isset($param['leimu_qualification']) ? img($param['leimu_qualification']) : '',
            'qualification_pics' => isset($param['product_qualification']) ? img($param['product_qualification']) : ''
        ];
