 ...
 * =========================================================
 * Copy right 2019-2029 科技发展有限公司, 保留所有权利。
 * ----------------------------------------------
...
use addon\memberrecharge\model\MemberrechargeOrderExport;
...
class Memberrecharge extends BaseAdmin
{
    ...
    public function order_lists()
    {
        ...
        if (request()->isAjax()) {
            ...
            $this->assign('list', $list);
            $this->assign('isempty', empty($list['data']['list'])?'true':'false');
    ...
    public function exportorder(){
        $condition_desc = [];
        $condition[] = [ 'status', '=', 2 ];
        $order_export_model = new MemberrechargeOrderExport();
