...
class MemberrechargeOrder extends BaseModel
{
    ...
    {
        $order_field = 'order_id,site_id,recharge_id,recharge_name,order_no,cover_img,face_value,buy_price,point,growth,coupon_id,price,pay_type,status,create_time,pay_time,member_id,member_img,nickname';
        ...
        if ($order_info[ 'status' ] == 1) {
            ...
            try {
                ...
                $message_model->sendMessage([ 'keywords' => "RECHARGE_SUCCESS", 'order_id' => $order_info['order_id'], 'site_id' => $order_info['site_id'] ]);
