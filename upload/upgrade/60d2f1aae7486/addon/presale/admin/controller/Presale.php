...
class Presale extends BaseAdmin
{
...
//            ['p.site_id', '=', $this->site_id],
    ...
    public function detail()
    {
        ...
        $presale_info = $presale_model->getPresaleJoinGoodsList($presale_id,$site_id);
        $this->assign('presale_info', $presale_info['data']);
    ...
    public function getSkuList()
    {
        if(request()->isAjax()){
            ...
            $presale_site_id = $presale_model->getPresaleInfo($condition,'site_id');

            $presale_info = $presale_model->getPresaleGoodsList($presale_id,$presale_site_id['data']['site_id']);
            return $presale_info;
        }
    }
