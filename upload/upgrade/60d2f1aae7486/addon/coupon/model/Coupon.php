...
class Coupon extends BaseModel
{
    ...
    public function receiveCoupon($coupon_type_id, $member_id, $get_type, $is_stock = 0, $is_limit = 1)
    {
        ...
        if (!empty($coupon_type_info)) {
            //优惠券是否限制领取上限
            if ($coupon_type_info['is_limitcount'] == 0) {
     ...
     * @param string $field
     */
    public function getCouponPageList($condition = [], $page = 1, $page_size = PAGE_LIST_ROWS, $order = 'fetch_time desc', $field = 'coupon_id,coupon_name,coupon_type_id,site_id,coupon_code,type,member_id,use_order_id,at_least,money,state,get_type,fetch_time,use_time,end_time')
    {
