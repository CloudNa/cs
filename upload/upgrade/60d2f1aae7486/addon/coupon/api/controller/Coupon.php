...
class Coupon extends BaseApi
{
    ...
    public function typepagelists()
    {
        ...
        $field = 'pct.coupon_type_id,pct.type,pct.site_id,pct.coupon_name,pct.is_limitcount,pct.money,pct.discount,pct.max_fetch,pct.at_least,pct.end_time,pct.image,pct.validity_type,pct.fixed_term,pct.status,pct.is_show,pct.goods_type,pct.discount_limit,pct.count,pct.lead_count,pct.site_name';
        if ($can_receive == 1) {
