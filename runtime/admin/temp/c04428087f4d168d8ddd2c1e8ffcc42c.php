<?php /*a:2:{s:68:"/www/wwwroot/niushop1.bucuoya.cn/app/admin/view/upgrade/upgrade.html";i:1619855886;s:57:"/www/wwwroot/niushop1.bucuoya.cn/app/admin/view/base.html";i:1619851154;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="ns-single-filter-box">
    ...
    <button class="layui-btn ns-bg-color" id="refresh_btn">一键刷新</button>
</div>
...
<script>
    ...
    layui.use(['form', 'laytpl'], function() {
        ...
        table = new Table({
            elem: '#version_list',
            url: ns.url("admin/upgrade/upgrade"),
        ...
        $("#upgrade_btn").click(function(){
            ...
            layer.open({
                ...
                yes: function () {
                    window.location.href = ns.url("admin/upgrade/upgradeAction");
                }
            });
        });
        ...
        $("#refresh_btn").click(function () {
            ...
            $.ajax({
                type: "post",
                url: ns.url('admin/upgrade/refresh'),
                dataType: "JSON",
                success: function (res) {
                    layer.msg(res.message);
                    layer.close(index);
