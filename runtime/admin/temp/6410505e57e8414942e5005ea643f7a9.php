<?php /*a:1:{s:47:"./app/component/view/goods_category/design.html";i:1645436732;}*/ ?>
		...
		<div class="goods-category-popup-wrap">
			<div class="goods-classification-style layui-form">
				<ul class="style-title">
					...
					<li v-bind:class="{'selected ns-bg-color': nc.level == 3}">三级分类样式</li>
				</ul>
				...
				<input type="hidden" class="layui-input" name="level" v-bind:value="nc.level">
				<input type="hidden" class="layui-input" name="template" v-bind:value="nc.template">
