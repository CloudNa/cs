<?php /*a:2:{s:67:"/www/wwwroot/niushop1.bucuoya.cn/app/install/view/index/step-3.html";i:1619851464;s:59:"/www/wwwroot/niushop1.bucuoya.cn/app/install/view/base.html";i:1619851462;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<style>
    ...
    .install-content-procedure .content-procedure-item:nth-child(3){
        background: url("http://niushop1.bucuoya.cn/app/install/view/public/img/conduct.png") no-repeat center / contain;
        color: #fff;
    }
</style>
...
<script language="javascript" type="text/javascript">
    ...
    function testDb()
    {
        ...
        inputBoxPointer('dbpwdsta').innerHTML='<img src="http://niushop1.bucuoya.cn/app/install/view/public/img/ajax-loader.gif">';
    ...
    function haveDB()
    {
        ...
        var dbpwd = inputBoxPointer('dbpwd').value;
        var dbport = inputBoxPointer('dbport').value;
        inputBoxPointer('havedbsta').innerHTML='<img src="http://niushop1.bucuoya.cn/app/install/view/public/img/ajax-loader.gif">';
