<?php /*a:2:{s:67:"/www/wwwroot/niushop1.bucuoya.cn/app/install/view/index/step-2.html";i:1619851464;s:59:"/www/wwwroot/niushop1.bucuoya.cn/app/install/view/base.html";i:1619851462;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="testing-item">
		...
		<table  border="0" align="center" cellpadding="0" cellspacing="0" class="twbox">
			...
			<tr>
				...
				<td><img clsss="check-icon" src="<?php if($variables_item['status']): ?>http://niushop1.bucuoya.cn/app/install/view/public/img/success.png<?php else: ?>http://niushop1.bucuoya.cn/app/install/view/public/img/error.png<?php endif; ?>"/></td>
			</tr>
			<?php endforeach; ?>
		</table>
	</div>
	...
	<div class="testing-item">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" class="twbox">
			...
			<tr>
				...
				<td>
					<img clsss="check-icon" src="<?php if($dirs_item['is_readable']): ?>http://niushop1.bucuoya.cn/app/install/view/public/img/success.png<?php else: ?>http://niushop1.bucuoya.cn/app/install/view/public/img/error.png<?php endif; ?>"/>
				</td>
				<td>
					<img clsss="check-icon" src="<?php if($dirs_item['is_write']): ?>http://niushop1.bucuoya.cn/app/install/view/public/img/success.png<?php else: ?>http://niushop1.bucuoya.cn/app/install/view/public/img/error.png<?php endif; ?>"/>
				</td>
			</tr>
			<?php endforeach; ?>
