<?php /*a:2:{s:58:"/www/wwwroot/duoshanghu/app/install/view/index/step-1.html";i:1619851462;s:50:"/www/wwwroot/duoshanghu/app/install/view/base.html";i:1619851462;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<!--<script src="http://139.155.92.125/app/install/view/public/js/jquery-2.2.js"></script>-->
	<link rel="icon" type="image/x-icon" href="http://139.155.92.125/public/static/img/shop_bitbug_favicon.ico" />
	<link rel="stylesheet" type="text/css" href="http://139.155.92.125/app/install/view/public/css/style.css" />
	<link rel="stylesheet" type="text/css" href="http://139.155.92.125/public/static/ext/layui/css/layui.css" />
	<link rel="stylesheet" type="text/css" href="http://139.155.92.125/app/shop/view/public/css/common.css" />
	<script src="http://139.155.92.125/public/static/js/jquery-3.1.1.js"></script>
	<script src="http://139.155.92.125/public/static/ext/layui/layui.js"></script>

	<script>
		layui.use(['layer', 'upload', 'element'], function() {});
		window.ns_url = {
			baseUrl: "http://139.155.92.125/install.php/",
			route: ['install', '<?php echo request()->controller(); ?>', '<?php echo request()->action(); ?>'],
		};
	</script>
	<script src="http://139.155.92.125/app/install/view/public/js/common.js"></script>
...
<div class="head-block">
	<div class="top">
		...
		<div class="top-sub" style="flex:1;">多商户</div>
	</div>
</div>
...
<div class="pright layui-form">
	...
	<div class="pr-agreement">
		...
		<strong>版权所有 (c)2016，shop多商户商城团队保留所有权利。</strong>
		<p>
			感谢您选择shop多商户商城（以下简称SHOP）SHOP基于 PHP + MySQL的技术开发，全部源码开放。 <br/>
			为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：
		</p>
		<p>
			<strong>一、本授权协议适用且仅适用于shop多商户商城系统(以下简称SHOP)任何版本，shop多商户商城官方对本授权协议的最终解释权。</strong>
		</p>
		<p>
			<strong>二、协议许可的权利 </strong>
		<ol>
			<li>非授权用户允许商用，严禁去除SHOP相关的版权信息。</li>
			<li>请尊重SHOP开发人员劳动成果，严禁使用本系统转卖、销售或二次开发后转卖、销售等商业行为。</li>
			<li>任何企业和个人不允许对程序代码以任何形式任何目的再发布。</li>
			<li>您可以在协议规定的约束和限制范围内修改shop多商户商城源代码或界面风格以适应您的网站要求。</li>
		...
		<ol>
			<li>未获商业授权之前，允许您对SHOP应用于商业用途，但严禁去除SHOP任何相关的版权信息。</li>
			<li>未经官方许可，不得对本软件或与之关联的商业授权进行出租、出售、抵押或发放子许可证。</li>
			<li>未经官方许可，禁止在shop多商户商城的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</li>
		...
		<ol>
			...
			<li>电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始确认本协议并安装
				SHOP，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。
			</li>
