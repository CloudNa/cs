<?php /*a:2:{s:67:"/www/wwwroot/niushop1.bucuoya.cn/app/install/view/index/step-4.html";i:1619851464;s:59:"/www/wwwroot/niushop1.bucuoya.cn/app/install/view/base.html";i:1619851462;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<!--<script src="http://niushop1.bucuoya.cn/app/install/view/public/js/jquery-2.2.js"></script>-->
	<link rel="icon" type="image/x-icon" href="http://niushop1.bucuoya.cn/public/static/img/shop_bitbug_favicon.ico" />
	<link rel="stylesheet" type="text/css" href="http://niushop1.bucuoya.cn/app/install/view/public/css/style.css" />
	<link rel="stylesheet" type="text/css" href="http://niushop1.bucuoya.cn/public/static/ext/layui/css/layui.css" />
	<link rel="stylesheet" type="text/css" href="http://niushop1.bucuoya.cn/app/shop/view/public/css/common.css" />
	...
	<script>
		...
		window.ns_url = {
			baseUrl: "http://niushop1.bucuoya.cn/install.php/",
			route: ['install', '<?php echo request()->controller(); ?>', '<?php echo request()->action(); ?>'],
		};
	</script>
	<script src="http://niushop1.bucuoya.cn/app/install/view/public/js/common.js"></script>
	
<style>
	.install-content-procedure .content-procedure-item:first-of-type{
		background: url("http://niushop1.bucuoya.cn/app/install/view/public/img/complete_two.png") no-repeat center / contain;
		color: #fff;
	}
	.install-content-procedure .content-procedure-item:nth-child(2), .install-content-procedure .content-procedure-item:nth-child(3){
		background: url("http://niushop1.bucuoya.cn/app/install/view/public/img/complete_four.png") no-repeat center / contain;
		color: #fff;
	}
	.install-content-procedure .content-procedure-item:nth-child(4){
		background: url("http://niushop1.bucuoya.cn/app/install/view/public/img/complete_three.png") no-repeat center / contain;
		color: #fff;
	}
...
<div class="install-success">
	<div class="install-success-box">
		<img class="install-success-pic" src="http://niushop1.bucuoya.cn/app/install/view/public/img/install_complete.png" alt="">
	...
	<ul class="other-links-list">
		<li class="other-links-item">
			<div  class="other-links-pic">
				<img src="http://niushop1.bucuoya.cn/app/install/view/public/img/site_backstage.png" alt="">
			</div>
			<a href="<?php echo htmlentities($root_url); ?>/index.php/admin" class="other-links-text" target="_blank">网站后台</a>
		</li>
		<li class="other-links-item">
			<div  class="other-links-pic">
				<img src="http://niushop1.bucuoya.cn/app/install/view/public/img/site_index.png" alt="">
			</div>
